    ...
    async seedTestData() {
        ...
        if (existingPeriodos === 0) {
            ...
            const periodoEnero = this.periodoRepository.create({
                ...
                tipo: 'mensual',
                estado: periodo_planilla_entity_1.PeriodoPlanilla.ESTADO_CERRADO,
            });
        ...
        if (conceptosCount === 0) {
            await this.conceptoRepository.save({
                ...
                modoCalculo: concepto_planilla_entity_1.ConceptoPlanilla.MODO_FIJO,
                baseCalculo: 1,
                activo: true,
            });
            await this.conceptoRepository.save({
            ...
            await this.conceptoRepository.save({
                ...
                tipo: concepto_planilla_entity_1.ConceptoPlanilla.TIPO_INGRESO,
                modoCalculo: concepto_planilla_entity_1.ConceptoPlanilla.MODO_VARIABLE,
                baseCalculo: 3,
                activo: true,
            });
            await this.conceptoRepository.save({
                ...
                modoCalculo: concepto_planilla_entity_1.ConceptoPlanilla.MODO_PORCENTAJE,
                baseCalculo: 4,
                activo: true,
            });
            await this.conceptoRepository.save({
